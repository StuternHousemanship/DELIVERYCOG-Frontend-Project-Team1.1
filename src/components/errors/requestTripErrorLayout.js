...
function RequestTripError() {
  const navigate = useNavigate();
  // /** Create Account Error Layout */
  const requestTripError = () => {
    return (
      <div>
        {/** Large screen */}
          ...
          <div className="flex justify-center items-center">
            <div className="my-[90px] h-[470px] w-[624px] bg-white  rounded-xl border-[#092C4C] border-[1px]">
              ...
              <h1 className=" mx-[160px]  w-[320px] h-31  mt-10 font-Inter  font-[900] text-[26px] leading-10  text-[#333333] ">
                Trip Request Unsuccessful
              </h1>
              <p className=" ml-[110px] mt-10 text-[#6D6464] text-[20px]">
                An error occured while requesting a trip
              </p>
              <button
                type="submit"
                title="verify-email"
  ...
  return (
    <div>
      {requestTripError()}
      {requestTripErrorMobile()}
    </div>
  );
}

export default RequestTripError;
