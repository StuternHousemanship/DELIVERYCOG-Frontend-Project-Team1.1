    ...
    return (
      <div className="sm:h-[100vh] sm:w-screen sm:bg-[#E5E5E5] flex justify-center items-center xs:w-[428px] xs:h-[900px] xs:bg-white  ">
        <form className="bg-white sm:w-[609px] sm:h-[438px] xs:w-full xs:h-full flex justify-center  relative">
          ...
          >
            <p className="text-[#424242] text-[14px] sm:font-[500] leading-[16px] mb-[6px] ">
              Email
            </p>
            <input
              type="email"
          ...
          <button type="button" onClick={() => navigate(NonAuthRoutes.logIn)}>
            <p className="text-[#424242] flex justify-center items-center text-center underline absolute sm:top-[318px] xs:top-[592px]">
              Back to Login
            </p>
          </button>
        </form>
